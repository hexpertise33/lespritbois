...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Un claustra ne borne aucune limite : il masque un axe de regard — local technique, vis-à-vis, coin de terrasse. Ajour, motif, ancrage, essences et budget : le guide d'un artisan à Libourne.",
  keywords:
