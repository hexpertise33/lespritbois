...
const GALERIE = [
  ...
  },
  {
    ...
    legende: 'Bioclimatique blanche, lames ouvertes',
    w: 768,
    h: 512,
  },
  {
    src: '/images/source-adefrance/Pergolas-aluminium-Libourne-5.webp',
    alt: 'Pergola bioclimatique avec éclairage LED intégré dans la structure',
    legende: 'Éclairage LED intégré aux traverses',
    w: 768,
    h: 512,
  },
  {
