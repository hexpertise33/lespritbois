...
export const ZONES: Zone[] = [
  {
    ...
    contexte: {
      ...
      paragraphes: [
        ...
        "Le sous-sol, lui, est calcaire sur une grande partie du secteur. Il porte bien, ce qui est une bonne nouvelle pour les massifs de fondation, mais il se creuse mal : une réservation qu'on croyait faite à la tarière se termine parfois au brise-roche. Nous le sondons avant de chiffrer plutôt que de le découvrir le jour de la pose.",
        "Enfin, beaucoup de ces communes sont dans le périmètre de la juridiction Saint-Émilion ou à proximité d'un monument inscrit. Cela ne bloque rien, mais cela change l'instruction : la teinte, la pente de toiture et parfois le matériau de couverture sont regardés. Nous préparons le dossier en conséquence, et nous le disons avant de dessiner, pas après le refus.",
      ],
    },
    chantiers: ['saint-pey-de-castets', 'capian', 'moulon', 'genissac', 'rauzan'],
    acces:
      "L'atelier est aux Billaux, à 20 à 30 minutes de la plupart des communes de l'Entre-deux-Mers. Nous n'y sous-traitons rien : les équipes qui relèvent sont celles qui posent.",
    faq: [
      {
        q: 'Intervenez-vous à Créon, Targon ou Branne ?',
        r: "Oui. Nos chantiers documentés vont de Génissac à Capian, ce qui couvre l'essentiel de l'Entre-deux-Mers, et l'atelier des Billaux est à moins de 30 minutes de Créon comme de Branne. Le déplacement pour le relevé et le devis est gratuit.",
      },
      {
      ...
      },
      {
        ...
        r: "Cela dépend de la surface créée et du PLU de votre commune, pas du secteur. Les seuils nationaux et le détail de la démarche sont expliqués dans notre guide des autorisations d'urbanisme. En revanche, si votre parcelle est dans un périmètre de monument ou dans la juridiction Saint-Émilion, l'instruction passe par un avis supplémentaire : nous le vérifions au relevé.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    chapo:
      "Notre atelier est aux Billaux, à trente-cinq minutes de Bordeaux. Nous intervenons sur la métropole, et nous préférons vous dire d'emblée ce que sa densité change à un chantier.",
    ...
    contexte: {
      ...
      paragraphes: [
        "Nos chantiers girondins sont pour l'essentiel en Libournais et en Entre-deux-Mers. Sur la métropole bordelaise, notre chantier documenté est à Montussan, dans les Coteaux Bordelais, à un quart d'heure de la rocade. Nous ne prétendrons pas à une longue liste de références intra-muros : ce serait faux, et vous le verriez au premier rendez-vous.",
    ...
    chantiers: ['montussan'],
    acces:
      "Trente-cinq minutes séparent l'atelier des Billaux du centre de Bordeaux par l'A89 puis la rocade. Le relevé et le devis sont gratuits sur la métropole comme ailleurs ; c'est au relevé que se décident l'accès, les longueurs de pièces et la faisabilité en limite.",
    faq: [
      {
        q: 'Vous déplacez-vous jusqu’à Bordeaux ?',
        r: "Oui. L'atelier est aux Billaux, à trente-cinq minutes du centre de Bordeaux, et notre chantier le plus proche de la métropole est à Montussan. Le déplacement pour le relevé et le devis est gratuit.",
      },
      {
